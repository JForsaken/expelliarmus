...
(deffacts informations
  (blessure-crime marque-de-la-mort)
  (victime-crime Malfoy)
  (lieu-crime dortoir)
  (heure-crime 14) 
    
  (personnage Malfoy at-l sortilege at-t 10) 
  (personnage Hermione at-l histoire-de-la-magie at-t 10);
  (personnage Marcus-Flint at-l histoire-de-la-magie at-t 10);
  (personnage Harry at-l vol at-t 10)
  
  (personnage Malfoy possede sterilet);
  (personnage Harry possede briquet)
  (personnage Fred-Weasley possede choixpeau)
  (personnage Marcus-Flint possede porte-poussiere)
  (personnage Hermione possede bombe-puante)
  (personnage Harry possede coupe-de-feu)
  
  (personnage Malfoy desire coupe-de-feu)
  (personnage Hermione desire sterilet);
  (personnage Marcus-Flint desire sterilet);
  (personnage Harry desire choixpeau)
  (personnage Hermione desire choixpeau)
  (personnage Marcus-Flint desire bombe-puante)
  (personnage Fred-Weasley desire porte-poussiere)

  (personnage Fred-Weasley lance accio sur Malfoy at-t 12)
  (personnage Harry lance avada-kedavra sur Malfoy at-t 11)
  (personnage Hermione lance imperio sur Marcus-Flint at-t 12);
  (personnage Marcus-Flint besoin envie-socialiser at-t 13);
)
