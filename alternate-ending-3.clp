...
;; Hermione est la victime
;; @ 15h
;; désire cire-a-chaussure
;; cire-a-chaussure dans la cuisine

;; faits
(deffacts informations
  (blessure-crime marque-de-la-mort) ; il portait cette blessure
  (victime-crime Hermione) ; ce personnage est mort
  (lieu-crime cuisine) ; dans la cuisine
  (heure-crime 15) ; pendant le 3e  cours de la journée

  (personnage Marcus-Flint at-l potions at-t 13)
  (personnage Harry at-l yoga at-t 14)

  (personnage Harry voit Hermione at-t 10)
  (personnage Harry voit Ron at-t 14)

  (personnage Hermione lance accio sur Harry at-t 11)
  (personnage Ron lance imperio sur Marcus-Flint at-t 12)
  (personnage Cho-Chang lance imperio sur Fred-Weasley at-t 12)

  (personnage Harry possede cire-a-chaussure)
  (personnage Cho-Chang possede porte-poussiere)
  (personnage Fred-Weasley possede horloge-de-la-famille-weasley)
  (personnage Malfoy possede briquet)

  (personnage Hermione desire cire-a-chaussure)
  (personnage Fred-Weasley desire cire-a-chaussure)
  (personnage Cho-Chang desire cire-a-chaussure) ; indice meurtre
  ...
  (personnage Fred-Weasley besoin faim at-t 15)
  (personnage Fred-Weasley voit cire-a-chaussure at-l cuisine)
...
(deffacts statut-personnage
  (personnage Ron est sang-de-bourbe)
  (personnage Harry est sang-pur)
  (personnage Hermione est sang-pur)
